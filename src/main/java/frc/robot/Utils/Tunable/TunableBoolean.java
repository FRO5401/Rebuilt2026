 ...
 *
 * <p>This class also implements {@link BooleanSupplier}, allowing it to be passed directly into
...
public class TunableBoolean implements BooleanSupplier {
   ...
   *
   * <p>{@link #initalizeDefault(boolean)} must be called before the value can be used.
   *
  ...
  /**
   * Initializes the default value and creates the NetworkTables publisher and subscriber if tuning
   * is enabled.
   *
   ...
   *
   * <p>If tuning is enabled, the value is read from NetworkTables. Otherwise, the stored default
   * value is returned.
   *
   ...
   *
   * <p>If a new value has been received from NetworkTables, the stored value is updated and this
   ...
   *
   * <p>This should be called when the tunable boolean is no longer needed to release NetworkTables
   * resources.
   */
  public void close() {
