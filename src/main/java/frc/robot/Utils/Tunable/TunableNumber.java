 ...
 *
 * <p>When tuning mode is enabled, the value is published to NetworkTables and
 * can be modified live through dashboards such as AdvantageScope,
 * Shuffleboard, or Elastic. When tuning mode is disabled, this class simply
 * returns the provided default value with no NetworkTables overhead.
 *
 * <p>This class also implements {@link DoubleSupplier}, allowing it to be
 * passed directly into commands, controllers, and other WPILib APIs that
 * accept a {@code DoubleSupplier}.
 */
 ...
 *
 * <p>{@link #initalizeDefault(double)} must be called before the value can be
 * used.
 *
 ...
 * @param m_disableTuning If true, this value will never be tunable even when
 *                         robot tuning mode is enabled.
 */
 ...
 */
    ...
    /**
 * Initializes the default value and creates the NetworkTables publisher and
 * subscriber if tuning is enabled.
 *
 * <p>This method only has an effect the first time it is called.
 *
 ...
 *
 * <p>If tuning is enabled, the value is read from NetworkTables. Otherwise,
 * the stored default value is returned.
 *
 ...
 *
 * <p>If a new value has been received from NetworkTables, the stored value is
 * updated and this method returns {@code true}.
 *
 ...
 */
    ...
    /**
     * Returns the current value as required by the {@link DoubleSupplier}
     * interface.
     *
     * @return Current value.
     */
     ...
     *
     * <p>This should be called when the tunable number is no longer needed to
     * release NetworkTables resources.
     */
    public void close(){
