 ...
 *
 * <p>This class also implements {@link DoubleSupplier}, allowing it to be passed directly into
...
public class TunableNumber implements DoubleSupplier {
   ...
   *
   * <p>{@link #initalizeDefault(double)} must be called before the value can be used.
   *
   ...
   *
   * <p>This should be called when the tunable number is no longer needed to release NetworkTables
   * resources.
   */
  public void close() {
