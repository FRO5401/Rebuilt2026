...
//     private static double hopperSizeX = RobotDimensionConstants.LENGTH_WBUMPERS.minus(Inches.of(7)).in(Meters);
//     private static double hopperSizeY = RobotDimensionConstants.WIDTH_WBUMPERS.in(Meters);
//     private static double hopperSizeZ = Units.inchesToMeters(21);
//     private static double hopperCenterZ = Units.inchesToMeters(12.5);
