...
public class Triangle {
  public static class TriangleBound implements Zone {
    ...
    public TriangleBound(
        Distance x1, Distance y1, Distance x2, Distance y2, Distance x3, Distance y3) {
      this(
          x1.in(Meters), x2.in(Meters), x3.in(Meters), y1.in(Meters), y2.in(Meters), y3.in(Meters));
    }
    ...
    public TriangleBound getMirrorBound() {
      return new TriangleBound(
          FieldZones.FIELD_LENGTH.in(Meters) - x3,
          FieldZones.FIELD_WIDTH.in(Meters) - y3,
          FieldZones.FIELD_LENGTH.in(Meters) - x2,
          FieldZones.FIELD_WIDTH.in(Meters) - y2,
          FieldZones.FIELD_LENGTH.in(Meters) - x1,
          FieldZones.FIELD_WIDTH.in(Meters) - y1);
    }
  }
}
