...
public class ZoneGetter {
  ...
  public static boolean isDrivebaseInZone(Rectangle2d zone, Pose2d robotPose) {
    return zone.contains(
            robotPose.transformBy(RobotDimensionConstants.BACK_LEFT_CORNER).getTranslation())
        || zone.contains(
            robotPose.transformBy(RobotDimensionConstants.BACK_RIGHT_CORNER).getTranslation())
        || zone.contains(
            robotPose.transformBy(RobotDimensionConstants.FRONT_LEFT_CORNER).getTranslation())
        || zone.contains(
            robotPose.transformBy(RobotDimensionConstants.FRONT_RIGHT_CORNER).getTranslation())
