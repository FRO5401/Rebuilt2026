...
public class CANdleSystem extends SubsystemBase {
  ...
  public void changeAnimation(AnimationTypes toChange) {
    ...
    switch (toChange) {
      ...
      case Larson:
        m_candle.setControl(
            new LarsonAnimation(m_candleChannel, LEDS_PER_ANIMATION)
      ...
      case RgbFade:
        m_candle.setControl(
            new ColorFlowAnimation(m_candleChannel, LEDS_PER_ANIMATION).withColor(null));
        break;
      ...
      case Strobe:
        m_candle.setControl(
            new StrobeAnimation(m_candleChannel, LEDS_PER_ANIMATION)
      ...
      case Looking:
        m_candle.setControl(
            new SingleFadeAnimation(m_candleChannel, LEDS_PER_ANIMATION)
